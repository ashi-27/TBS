  ...
  <header className="position-absolute w-100">
    <div className="container">
      ...
      <nav className="navbar navbar-expand-md navbar-light">
        ...
        {/* <Switch><li className="nav-item"><Link to={"/UI"} className="nav-link">Home<Route exact path="/UI" component={UI} /></Link></li></Switch>
        <Switch><li className="nav-item"><Link to={"/Contactus"} className="nav-link">Contact us<Route exact path="/Contactus" component={Contactus} /></Link></li></Switch>
        <Switch><li className="nav-item"><Link to={"/Aboutus"} className="nav-link">About us<Route exact path="/Aboutus" component={Aboutus} /></Link></li></Switch>
          */}
      ...
      <div className="row">
        ...
        <div className="swiper-slide slide-content d-flex align-items-center">
                <div className="single-slide">
                  ...
                  <h2><p>This is a Simple Ticket Booking System developed by Team 5.</p></h2>
                </div>
              </div>
              </div>
            </div>
