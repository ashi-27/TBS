...
{/*         
        <Switch><li className="nav-item"><Link to={"/App"} className="nav-link">Home<Route exact path="/App" component={Ui1} /></Link></li></Switch>
        ...
        <Switch><li className="nav-item"><Link to={"/Aboutus"} className="nav-link">About us<Route exact path="/Aboutus" component={Aboutus} /></Link></li></Switch> */}
          ...
          </ul>   <form className="bg-white search-form" method="get" id="searchform">
